...
public class ThuongHieuView extends javax.swing.JFrame {
    ...
    ThuongHieuService service = new ThuongHieuService(); 
    ...
    private void initComponents() {
        ...
        tbl_ThuongHieu.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Thương Hiệu", "Ngày tạo", "Trạng thái"
            }
        ));
...
//    }
    ...
    private void fillTable(List<ThuongHieu> list) {
        mol =(DefaultTableModel) tbl_ThuongHieu.getModel();
        mol.setRowCount(0);
        for (ThuongHieu x : list) {
            mol.addRow(new Object[]{
                x.getIdThuongHieu(),x.getTenThuongHieu(),x.getNgayTao(),x.getTrangThai()
            });
        }
    }
    ...
    ThuongHieu getData() {
        ...
        th.setIdThuongHieu(txt_IDNSX.getText());
        th.setTenThuongHieu(txt_TenNSX.getText());
        th.setNgayTao(txt_ngayTao.getText());
        th.setTrangThai(cbo_trangThai.getSelectedItem().toString());
        return th;
    }
    
    void setForm(int index){
        ThuongHieu th = service.getAll().get(index);
        txt_IDNSX.setText(th.getIdThuongHieu());
        txt_TenNSX.setText(th.getTenThuongHieu());
        txt_ngayTao.setText(th.getNgayTao());
        cbo_trangThai.setSelectedItem(th.getTrangThai());
    }
    ...
    void xoa() {
        try {
            if (MSGHeper.confirm(this, "Bạn Có Chắc Chắn Muốn Xóa Không")) {
                service.delete(Integer.valueOf(tbl_ThuongHieu.getValueAt(tbl_ThuongHieu.getSelectedRow(), 0).toString()));
    ...
    void sua() {
        try {
            service.update(getData(),Integer.valueOf(tbl_ThuongHieu.getValueAt(tbl_ThuongHieu.getSelectedRow(), 0).toString()));
